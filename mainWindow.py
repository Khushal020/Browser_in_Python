...
class MainWindow(QMainWindow):
    ...
    def closeEvent(self, event):  
        ...
        file = open('./res/history.txt', 'a+', encoding='utf-8') # a+ mode opens in read+write, appending to end of file and creating file if it doesn't exist
